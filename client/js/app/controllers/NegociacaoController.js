...
System.register(['../models/ListaNegociacao', '../models/Mensagem', '../views/NegociacoesView', '../views/mensagemView', '../services/NegociacaoService', '../helpers/DataHelper', '../helpers/Bind', '../models/Negociacao'], function (_export, _context) {
    "use strict";

    var ListaNegociacao, Mensagem, NegociacoesView, MensagemView, NegociacaoService, DataHelper, Bind, Negociacao, _createClass, NegociacaoController, negociacaoController;
            ...
            NegociacaoController = function () {
                ...
                _createClass(NegociacaoController, [{
                    ...
                    value: function importaNegociacoes() {
                        ...
                        this._service.importa(this._listaNegociacao.negociacao).then(function (negociacoes) {
                            return negociacoes.forEach(function (negociacao) {
